...
ListRouter.get("/:boardId", TokenExtraction, async (req, res) => {
    try {
...
*/
ListRouter.post("/:boardId", TokenExtraction, async (req, res) => {
    try {
        // 1. Get and validate the user id, board id and list data
        const userId = req.userId;
        const boardId = req.params.boardId?.trim();
...
*/
ListRouter.patch("/:listId", TokenExtraction, async (req, res) => {
    try {
        // 1. Get and validate the user id, list id and list data
        const userId = req.userId;
...
*/
ListRouter.delete("/:listId", TokenExtraction, async (req, res) => {
    // 1. Get and validate the user id, and the list id
    try {
        const listId = req.params.listId?.trim();
        if (!listId) {
