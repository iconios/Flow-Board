...
// Create a Board API
BoardRouter.post("/", TokenExtraction, async (req, res) => {
  const body = { ...req.body };
...
// Update a Board API
BoardRouter.patch("/:boardId", TokenExtraction, async (req, res) => {
  try {
...
BoardRouter.get("/", TokenExtraction, async (req, res) => {
  try {
...
BoardRouter.delete("/:boardId", TokenExtraction, async (req, res) => {
  try {
    // Get the parameters
    const user = req.userId;
    const board = req.params.boardId;
