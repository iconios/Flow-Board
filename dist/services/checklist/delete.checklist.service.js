...
import { DeleteChecklistInputSchema, } from "../../types/checklist.type.js";
import Checklist from "../../models/checklist.model.js";
import Board from "../../models/board.model.js";
import BoardMember from "../../models/boardMember.model.js";
import { produceActivity } from "../../redis/activity.producer.js";
import { de } from "zod/locales";
const DeleteChecklistService = async (deleteChecklistInput) => {
    try {
        const { userId, checklistId } = DeleteChecklistInputSchema.parse(deleteChecklistInput);
        ...
        if (isDeleted) {
            ...
            }).catch((err) => console.error(`Activity log failed for checklist deletion: ${checklistId}`, err));
        }
        return {
            success: isDeleted,
            message: isDeleted
...
//# sourceMappingURL=delete.checklist.service.js.map