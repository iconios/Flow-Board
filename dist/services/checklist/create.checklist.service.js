...
import { CreateChecklistInputSchema, } from "../../types/checklist.type.js";
import Board from "../../models/board.model.js";
import BoardMember from "../../models/boardMember.model.js";
import Task from "../../models/task.model.js";
import Checklist from "../../models/checklist.model.js";
import { produceActivity } from "../../redis/activity.producer.js";
const CreateChecklistService = async (createChecklistInput) => {
    try {
        // 1. Get and validate the checklist content, task id, board id, and user id
        const { content, taskId, boardId, userId } = CreateChecklistInputSchema.parse(createChecklistInput);
        ...
        void produceActivity({
            ...
            userId,
        }).catch((err) => console.error(`Activity log failed for checklist creation: ${createdChecklist._id.toString()}`, err));
        return {
            success: true,
