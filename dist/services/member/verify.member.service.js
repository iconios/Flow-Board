...
const VerifyBoardMemberService = async (verificationToken) => {
    ...
    if (!updatedMember) {
        ...
        return {
            success: false,
            message: "The verification link is invalid or member verification already done",
            error: "INVALID OR EXPIRED LINK",
        };
    }
    console.log(`Member ${updatedMember._id.toString()} is verified and records updated`);
    // 3. Send a successful board membership acceptance email to the member
