...
import { UpdateMemberRoleSchema, } from "../../types/member.type.js";
import { ZodError } from "zod";
import Board from "../../models/board.model.js";
import BoardMember from "../../models/boardMember.model.js";
import { produceActivity } from "../../redis/activity.producer.js";
const UpdateMemberRoleService = async (ownerId, memberData) => {
    try {
        // 1. Get the owner id, board id, member id and validate them
        const { memberId, board_id, role } = UpdateMemberRoleSchema.parse(memberData);
        ...
        void produceActivity({
            ...
            object: "Member",
            objectId: memberId,
        }).catch((err) => console.error(`Activity log failed for member role update: ${memberId}`, err));
        // 5. Send op status to client
        return {
            success: true,
...
//# sourceMappingURL=update.member.service.js.map