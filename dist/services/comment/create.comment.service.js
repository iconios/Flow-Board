...
import { CreateCommentInputSchema, } from "../../types/comment.type.js";
import List from "../../models/list.model.js";
import Comment from "../../models/comment.model.js";
import { ZodError } from "zod";
import BoardMember from "../../models/boardMember.model.js";
import { produceActivity } from "../../redis/activity.producer.js";
const CreateCommentService = async (userId, taskId, commentData) => {
    try {
        // 1. Get and validate the comment data
        ...
        }).catch((err) => console.error(`Activity log failed for comment creation: ${commentCreated._id.toString()}`, err));
        // 4. Send the details of the created comment to user
        return {
            success: true,
