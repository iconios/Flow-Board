...
import { CreateActivityInputSchema, } from "../../types/activity.type.js";
import { MongooseError, Types } from "mongoose";
import Board from "../../models/board.model.js";
import Task from "../../models/task.model.js";
const CreateActivityService = async (userId, activityData) => {
    try {
        // 1. Get and validate the user id and other activity data
        ...
        console.log(`Success: Activity log type - ${savedActivity.activityType} for user - ${userId} on object - ${savedActivity.object} created`);
        return {
            success: true,
...
//# sourceMappingURL=create.activity.service.js.map