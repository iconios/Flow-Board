...
import { ReadActivityInputSchema, } from "../../types/activity.type.js";
import Board from "../../models/board.model.js";
import List from "../../models/list.model.js";
import { ZodError } from "zod";
const ReadActivityService = async (userId, limit, skip, activityData) => {
    try {
        // 1. Get, verify and validate the user id
        ...
        return {
            success: true,
            message: userActivityToReturn.length === 0
...
//# sourceMappingURL=read.activity.service.js.map